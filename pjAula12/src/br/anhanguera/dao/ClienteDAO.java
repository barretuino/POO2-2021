...
public class ClienteDAO {
	...
	//Método de Pesquisa
	public Cliente pesquisar(Double cpf) throws SQLException {
		//criado o objeto de retorno
		...
		try {
			...
			while (rs.next()) {                
				...
				clienteRet.setEndComplemento(rs.getString(8));  
				clienteRet.setSexo(rs.getString(9));				              
			}
